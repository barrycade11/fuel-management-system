...
const UserRegistration = () => {
  ...
  const { refetch } = useFetchStationIdAndName()
  ...
  return (
    <div className="flex flex-col bg-white flex-grow justify-center items-center">
      ...
      <form className="w-3/4 flex flex-col md:w-[550px] pt-7 border border-default-200">
        ...
        <div className="flex flex-row gap-5 px-10">
          <div className="flex-1">
            <TextBoxField
              label="Username"
              onChange={(e) => handleFormUpdate("username", e.target.value)} // Pass 'key' and value to onChange
            />
          </div>
          <div className="flex-1">
            <TextBoxField
              label="Password"
              type="Password"
              onChange={(e) => handleFormUpdate("password", e.target.value)} // Pass 'key' and value to onChange
            />
          </div>
        </div>
        ...
        <div className="flex flex-row gap-5 px-10">
          <div className="flex-1">
            <TextBoxField
              label="Lastname"
              onChange={(e) => handleFormUpdate("lastname", e.target.value)} // Pass 'key' and value to onChange
            />
          </div>
          <div className="flex-1">
            <TextBoxField
              label="Firstname"
              onChange={(e) => handleFormUpdate("firstname", e.target.value)} // Pass 'key' and value to onChange
            />
          </div>
        </div>
        ...
        <div className="flex flex-col flex-1 pt-5 px-10">
          ...
          <SelectOptionRole
            onChange={(e) => handleFormUpdate('userRole', e.target.value)}
          />
        </div>
        ...
        <div className="flex flex-col flex-1 pt-5 px-10 pb-5">
          ...
          <Select
            onChange={(e) => handleFormUpdate("status", e.target.value)} // Pass 'key' and value to onChange
